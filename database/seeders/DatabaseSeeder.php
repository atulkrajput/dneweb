...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Pages SEO
        $pages = [
            ['slug' => 'home', 'meta_title' => 'AI Automation & Technology Solutions | DNE Consultants', 'meta_description' => 'DNE Consultants delivers AI automation, SaaS development, web & mobile apps, and managed IT services. One team. Full accountability. Real results.'],
        ...
        $legalPages = [
            [
                ...
                'meta_description' => 'Learn how DNE Technology Consultants collects, uses, and protects your personal information.',
            ...
            [
                ...
                'meta_description' => 'Terms and conditions for using DNE Technology Consultants website and services.',
