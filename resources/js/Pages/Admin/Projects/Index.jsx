          ...
          <table className="w-full">
            <thead className="bg-muted/50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Tasks</th>
              ...
              {projects.data?.map((project) => {
                ...
                return (
                  <tr key={project.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${project.pending_tasks_count > 0 ? 'bg-orange-500/10 text-orange-400' : 'bg-green-500/10 text-green-400'}`}>
